...
class A4_MulT_ta(nn.Module):
    def __init__(self, hyp_params):
        ...
        self.vonly = False  # Vision only flag
        self.aonly = True  # Audio only flag
        self.lonly = True  # text only flag
        ...
        self.out_layer = nn.Linear(combined_dim, output_dim)  # Final output layer
    ...
    def forward_final(self, proj_x_a, proj_x_v, proj_x_l):
        ...
        # Check each variable for None and return accordingly
        result_l = "none" if last_h_l is None else last_h_l
        result_a = "none" if last_h_a is None else last_h_a
        result_v = "none" if last_h_v is None else last_h_v
